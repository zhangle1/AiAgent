...
public sealed class AgentContext
{
    ...
    /// <summary>Server-validated generated project map for a code-oriented turn.</summary>
    public string ProjectAgentMarkdownIndexContext { get; set; } = string.Empty;
    ...
    public static AgentContext FromRequest(ChatCompleteRequest request)
    {
        ...
        return new AgentContext
        {
            ...
            ProjectAgentMarkdownIndexContext = request.ServerProjectAgentMarkdownIndexContext ?? string.Empty
        };
    }
