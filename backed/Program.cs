...
builder.Services.AddSingleton<RepositoryMaintenanceBuildService>();
builder.Services.AddSingleton<RepositoryMaintenanceService>();
builder.Services.AddHostedService<RepositoryMaintenanceHostedService>();
