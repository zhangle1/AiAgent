...
public sealed class AiProjectTask
{
    ...
    [SugarColumn(Length = 64, IsNullable = true)] public string? WorkItemId { get; set; }
    [SugarColumn(Length = 64, IsNullable = true)] public string? WorkItemType { get; set; }
    ...
    [SugarColumn(Length = 64, IsNullable = true)] public string? Creator { get; set; }
    [SugarColumn(Length = 64, IsNullable = true)] public string? Assignee { get; set; }
    [SugarColumn(Length = 1024, IsNullable = true)] public string? Collaborators { get; set; }
    [SugarColumn(Length = 32, IsNullable = true)] public string? Priority { get; set; }
    [SugarColumn(Length = 512, IsNullable = true)] public string? Labels { get; set; }
    [SugarColumn(Length = 1024, IsNullable = true)] public string? ExternalUrl { get; set; }
    [SugarColumn(IsNullable = true)] public DateTime? ExternalCreatedAt { get; set; }
